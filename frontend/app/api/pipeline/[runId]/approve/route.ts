/**
 * API Route: POST /api/pipeline/[runId]/approve
 *
 * Approves a pipeline at a human approval gate.
 */
...
export async function POST(
  ...
  try {
    ...
    // Build backend URL
    const backendUrl = buildBackendUrl(BACKEND_ENDPOINTS.PIPELINE_APPROVE(runId));

    console.log(`[${requestId}] Approving pipeline: ${backendUrl}`);
    ...
    try {
      ...
      console.log(`[${requestId}] Pipeline approved successfully in ${duration}ms`);
